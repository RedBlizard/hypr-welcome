...
show_main_menu() {
    while true; do
        main_menu="Hyprland\nWaybar configs\nWaybar styles"
        selected_config=$(echo -e "$main_menu" | yad --title="Change your configs" --text="" --list --column="Configs" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")
...
launch_hyprland_settings() {
    ...
    while true; do
        ...
        selected_file=$(echo -e "$submenu" | yad --title="Hyprland lua configs" --text="" --list --column="Lua-configs" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path") 
...
launch_waybar_configs() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Configs" --text="" --list --column="Configs" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")
...
launch_waybar_styles() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Styles" --text="" --list --column="Styles" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")

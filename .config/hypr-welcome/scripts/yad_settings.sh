...
show_main_menu() {
    while true; do
        main_menu="Hyprland\nWaybar configs\nWaybar styles"
        selected_config=$(echo -e "$main_menu" | yad --title="Settings" --text="" --width=900 --height=445 --fixed --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")
...
launch_hyprland_settings() {
    ...
    while true; do
        ...
        selected_file=$(echo -e "$submenu" | yad --title="Hyprland Settings" --text="" --width=900 --height=445 --fixed --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path") 
...
launch_waybar_configs() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Configs" --text="" --width=900 --height=445 --fixed --list --column="Configs" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")

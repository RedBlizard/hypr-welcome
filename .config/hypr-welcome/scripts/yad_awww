...
show_main_menu() {
    while true; do
        ...
        selected_config=$(echo -e "$main_menu" | yad --title="Awww" --text="" --list --column="Awww" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")
...
launch_awww_options() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Change your settings" --text="" --list --column="Change your settings" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")

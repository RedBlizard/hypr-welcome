...
show_main_menu() {
    while true; do
        ...
        selected_config=$(echo -e "$main_menu" | yad --title="Awww" --text="" --width=900 --height=445 --fixed --list --column="Awww" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")
...
# Function to launch Awww options submenu
launch_awww_options() {
    while true; do
        submenu="Back to main menu\nKill awww\nChange Wallpaper Directory\nInitialize awww"
        selected_submenu=$(echo -e "$submenu" | yad --title="Change your settings" --text="" --width=900 --height=445 --fixed --list --column="Change your settings" --separator='\n' --borders=9 -timeout=5 --button="   Kill me i dare you ..." --center --image="$logo_path")

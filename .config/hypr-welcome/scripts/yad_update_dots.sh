...
folders=("alacritty" "btop" "cava" "dunst" "hypr" "hypr-welcome" "kitty" "Kvantum" "networkmanager-dmenu" "nwg-look" "pacseek" "pipewire" "qt6ct" "ranger" "sddm-config-editor" "systemd" "Thunar" "waybar" "waypaper" "wlogout" "wofi" "xsettingsd" "gtk-2.0" "gtk-3.0" "gtk-4.0" "starship" "swaync")
...
check_symlinks() {
    local symlinks=("hypr-welcome" "hypr-eos-kill-yad-zombies" "hypr_check_updates" "select-wallpaper -s")
...
if ! check_symlinks; then
    ...
    wallpaper_selector_script="$HOME/.config/hypr-welcome/scripts/select-wallpaper -s"
    symlink="/usr/bin/select-wallpaper -s"
